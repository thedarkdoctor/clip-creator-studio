# 📋 Lynkscope → Cliplyst Integration Requirements & Checklist
...
- ✅ Cliplyst API URL (production endpoint)
- ✅ VITE_LYNKSCOPE_INTERNAL_KEY (random 32-char hex)
- ✅ JWT_SECRET (random 32-char hex)
- ✅ CORS whitelist confirmation (Lynkscope domain added)
